...
- (void)renderAtPoint:(CGPoint)point{
	...
	[self renderSubImageAtPoint:point offset:texOffsetPoint subImageWidth:imageWidth subImageHeight:imageHeight];
}


- (void)renderSubImageAtPoint:(CGPoint)point offset:(CGPoint)offsetPoint subImageWidth:(GLfloat)subImageWidth subImageHeight:(GLfloat)subImageHeight{
	...
	/* else {
		quadVertices[0] = quadWidth + point.x;
		quadVertices[1] = quadHeight+ point.y;
		
		quadVertices[2] = quadWidth + point.x;
		quadVertices[3] = 0+ point.y;
		
		quadVertices[4] = 0 + point.x;
		quadVertices[5] = quadHeight+ point.y;
		
		quadVertices[6] = 0 + point.x;
		quadVertices[7] = 0+ point.y;
	}*/		
