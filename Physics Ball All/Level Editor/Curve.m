...
@synthesize curve0,curve1,curve2,curvePtX,curvePtY,type,originalCurve0,originalCurve1,originalCurve2,snapped,snap0,snap1,snap2,snap3,snap4,snap5,xBounds,yBounds;
...
- (void)drawHoldCircle:(CGPoint)position context:(CGContextRef)theContext {
	...
	CGContextSetRGBStrokeColor(theContext, 0.0, 0.0, 0.0, 0.5);
	CGRect rectangle = CGRectMake(position.x - 5,position.y - 5,10,10);
